...
const MobileNavLink = ({
  ...
  <Link
    to={to}
    onClick={onClick}
    className="flex items-center w-full p-3 text-base font-medium text-slate-700 rounded-lg hover:bg-slate-100"
  >
    {children}
  </Link>
);
              ...
              <>
                ...
                <div className="pt-4 border-t mt-4 space-y-2">
                  <MobileNavLink
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <UserIcon className="w-5 h-5 mr-3 text-slate-500" /> Mi
                    Perfil
                  </MobileNavLink>
                  {user?.role === 'student' && (
                    <Button
